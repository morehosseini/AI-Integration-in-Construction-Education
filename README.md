![AI Integration in AEC Education Banner](docs/graphics/repository_banner.png)
...
- **Chapter 6:** AI in Construction: Identifying Competencies and Analysing Teaching Methods *(Accepted)*
...
All resources are organized by chapter in the `/chapters` directory. See [REPOSITORY-STRUCTURE.md](REPOSITORY-STRUCTURE.md) for details on what is included in each chapter's folder.
